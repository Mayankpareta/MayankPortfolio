    ...
    <div>
        <div id='about'  className='g-gradient-to-r from-[#222222] to-[#000000] min-h-52 lg:py-20 py-5'>          
            <div className='text-center '>
                <h2 className='text-xl sm:text-4xl pt-4 md:pt-0 text-clip inline-block
                 '>About Me</h2>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-7 lg:gap-20 py-5 md:py-10 lg:py-20'>
              ...
              <div className='px-5'>
                ...
                <p
                className=' py-2'
                >Hey there! I'm <b className=''> Mayank Pareta </b>, a passionate front-end developer with a deep love for web development and creating digital experiences that make an impact.
                </p>
